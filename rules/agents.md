...
- Go beyond static checks: use available tools or any capability to test the feature where it actually runs
- If a runtime environment is available, use it; don't skip it just because static checks passed
